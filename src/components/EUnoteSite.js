...
const EUnoteSite = () => {
  ...
  return (
    <div className="EU-note">
        ...
        <div className="text">Projekt i izrada internetske stranice sufinancirani su sredstvima Europske unije, Operativnog programa „Konkurentnost i kohezija“ iz Europskog fonda za regionalni razvoj.</div>
    </div>
  )
}
